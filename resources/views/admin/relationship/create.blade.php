...
@section('content')
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.relationship.store') }}" name="addfrm" id="addfrm" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" value="{{ old('name', isset($relationship) ? $relationship->name : '') }}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 controls">
                                    ...
                                    <div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                        <input type="checkbox" name="status" class="form-check-input" {{ isset($relationship) && $relationship->status === 1 ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <a href="{{ route('admin.relationship.index') }}" class="btn btn-secondary w-md button-responsive">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
